...
var getColumnById = exports.getColumnById = function getColumnById(table, columnId) {
  return table.columns.find(function (col) {
...
var getColumnByKey = exports.getColumnByKey = function getColumnByKey(table, columnKey) {
  return table.columns.find(function (col) {
    return col.columnKey === columnKey;
  });
};
...
exports.default = {
  ...
  methods: {
    ...
    tempMousewheel: function tempMousewheel(event, data) {
      console.log('tempMousewheel', event, data, this.bodyWrapper.scrollTop);
      var scrollTop = this.bodyWrapper.scrollTop + Math.ceil(data.pixelY);
      var scrollLeft = this.bodyWrapper.scrollLeft + Math.ceil(data.pixelX);
      ...
      if (this.height) {
        var minScrollTop = this.store.states.scrollInfo && this.store.states.scrollInfo.minScrollTop || null;
        var maxScrollTop = this.store.states.scrollInfo && this.store.states.scrollInfo.maxScrollTop || null;
    ...
    updateScrollForVirtual: function updateScrollForVirtual() {
  ...
  computed: {
    ...
    updateRenderRowsDebounced: function updateRenderRowsDebounced() {
      ...
      return (0, _debounce2.default)(80, function () {
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"el-table",class:[{
    ...
    'el-table--enable-row-transition': (_vm.store.states.data || []).length !== 0 && (_vm.store.states.data || []).length < 100
      ...
      }),attrs:{"store":_vm.store,"border":_vm.border,"default-sort":_vm.defaultSort}})],1):_vm._e(),_c('div',{directives:[{name:"mousewheel",rawName:"v-mousewheel",value:(_vm.tempMousewheel),expression:"tempMousewheel"}],ref:"bodyWrapper",staticClass:"el-table__body-wrapper",class:[_vm.layout.scrollX ? ("is-scrolling-" + _vm.scrollPosition) : 'is-scrolling-none'],style:([_vm.bodyHeight])},[_c('div',{staticClass:"spacer-before",style:({ height: 1 + 'px'})}),_c('table-body',{ref:"tableMain",style:({
         width: _vm.bodyWidth
        ...
        width: _vm.layout.bodyWidth ? _vm.layout.bodyWidth + 'px' : ''
      }),attrs:{"store":_vm.store,"border":_vm.border,"sum-text":_vm.sumText || _vm.t('el.table.sumText'),"summary-method":_vm.summaryMethod,"default-sort":_vm.defaultSort}})],1):_vm._e(),(_vm.fixedColumns.length > 0)?_c('div',{ref:"fixedWrapper",staticClass:"el-table__fixed",style:([{
    ...
    _vm.fixedHeight])},[(_vm.showHeader)?_c('div',{ref:"fixedHeaderWrapper",staticClass:"el-table__fixed-header-wrapper"},[_c('table-header',{ref:"fixedTableHeader",style:({
          width: _vm.bodyWidth
        }),attrs:{"fixed":"left","border":_vm.border,"store":_vm.store}})],1):_vm._e(),_c('div',{directives:[{name:"mousewheel",rawName:"v-mousewheel",value:(_vm.handleFixedMousewheel),expression:"handleFixedMousewheel"}],ref:"fixedBodyWrapper",staticClass:"el-table__fixed-body-wrapper",style:([{
        top: _vm.layout.headerHeight + 'px'
      },
      _vm.fixedBodyHeight])},[_c('div',{staticClass:"spacer-before",style:({ height: 1 + 'px'})}),_c('table-body',{ref:"tableLeft",style:({
              width: _vm.layout.fixedWidth ? _vm.layout.fixedWidth + 'px' : ''
          ...
          width: _vm.bodyWidth
        }),attrs:{"fixed":"left","border":_vm.border,"sum-text":_vm.sumText || _vm.t('el.table.sumText'),"summary-method":_vm.summaryMethod,"store":_vm.store}})],1):_vm._e()]):_vm._e(),(_vm.rightFixedColumns.length > 0)?_c('div',{ref:"rightFixedWrapper",staticClass:"el-table__fixed-right",style:([{
    ...
    _vm.fixedHeight])},[(_vm.showHeader)?_c('div',{ref:"rightFixedHeaderWrapper",staticClass:"el-table__fixed-header-wrapper"},[_c('table-header',{ref:"rightFixedTableHeader",style:({
          width: _vm.bodyWidth
        }),attrs:{"fixed":"right","border":_vm.border,"store":_vm.store}})],1):_vm._e(),_c('div',{directives:[{name:"mousewheel",rawName:"v-mousewheel",value:(_vm.handleFixedMousewheel),expression:"handleFixedMousewheel"}],ref:"rightFixedBodyWrapper",staticClass:"el-table__fixed-body-wrapper",style:([{
        top: _vm.layout.headerHeight + 'px'
      },
      _vm.fixedBodyHeight])},[_c('div',{staticClass:"spacer-before",style:({ height: 1 + 'px'})}),_c('table-body',{ref:"tableRight",style:({
