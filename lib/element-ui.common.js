...
exports.default = (_name$mixins$directiv = {
  name: 'ElTable',
  ...
  methods: {
    ...
    onScrollLeft: function onScrollLeft(e) {
      if (!this.scrolling) {
...
}, _name$mixins$directiv['data'] = function data() {
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"el-table",class:[{
    ...
    _vm.fixedHeight])},[(_vm.showHeader)?_c('div',{ref:"fixedHeaderWrapper",staticClass:"el-table__fixed-header-wrapper"},[_c('table-header',{ref:"fixedTableHeader",style:({
      ...
      _vm.fixedBodyHeight])},[_c('div',{directives:[{name:"mousewheel",rawName:"v-mousewheel",value:(_vm.handleFixedMousewheel),expression:"handleFixedMousewheel"}],ref:"fixedBodyWrapperInner",staticClass:"el-table__fixed-body-wrapper-inner",style:([
      {
        width: _vm.layout.fixedWidth ? _vm.layout.fixedWidth + _vm.layout.gutterWidth + 'px' : ''
      },
